...
# The Mean is .230448 and SD is .2791 so the z-score is .33931 and so the p-value is .367188 and since that is less than .05 this is just coincidence rather than fact, we can not reject that this because of random chance.
